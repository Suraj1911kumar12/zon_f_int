  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4 bg-slate-50 relative overflow-hidden">
      ...
      <div className="bg-white p-8 md:p-10 rounded-2xl w-full max-w-md shadow-xl border border-slate-100 z-10">
        <h2 className="text-3xl font-extrabold tracking-tight text-slate-900 text-center mb-2">Welcome Back</h2>
        <p className="text-sm text-slate-500 text-center mb-8">Login to manage your tasks</p>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition cursor-pointer animate-none"
              >
